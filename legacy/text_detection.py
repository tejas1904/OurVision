...
parser.add_argument('--input',default="billboard.jpeg",
                    help='Path to input image or video file. Skip this argument to capture frames from a camera.')
parser.add_argument('--model', '-m', default="east.pb",
...
def main():
        ...
        print(f" detector = {tickmeter.getTimeMilli()}")
        ...
        for i in indices:
            ...
            if modelRecognition:
                ...
                print(f" recog = {tickmeter.getTimeMilli()}")
