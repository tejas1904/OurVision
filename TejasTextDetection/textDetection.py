    ...
    while cv.waitKey(1) < 0:
        ...
        for i in indices:
            ...
            if modelRecognition:
                ...
                print(f"{wordRecognized}@ (X:{int(vertices[1][0])},{int(vertices[1][1])}")
                coordX=(int(vertices[1][0])+int(vertices[3][0]))/2
                coordY=(int(vertices[1][1])+int(vertices[3][1]))/2
                words_list.append([coordX,coordY,wordRecognized])
        ...
        print("finally------")
        words_list=sorted(words_list,key=lambda k:[k[1],k[0]])
        for i in words_list:
            print(i[2])
